...
namespace PAC.Managers
{
    public class DrawingArea : MonoBehaviour
    {
        ...
        private void HoldClickTool(Tool tool, IntVector2 pixel, int layer, int frame, Color colour)
        {
            ...
            {
                if (toolbar.shapeToolShape == ShapeTool.ShapeMode.Rectangle)
                {
                    IntVector2 end = pixel;
                    if (holdingCtrl)
                    {
                ...
                else if (toolbar.shapeToolShape == ShapeTool.ShapeMode.Ellipse)
                {
                    IntVector2 end = pixel;
                    if (holdingCtrl)
                    {
                ...
                else if (toolbar.shapeToolShape == ShapeTool.ShapeMode.RightTriangle)
                {
                    PreviewShape(new RightTriangle(mouseDragPoints[0], pixel, !holdingCtrl, rightClickedOn), colour);
                }
                else if (toolbar.shapeToolShape == ShapeTool.ShapeMode.Diamond)
                {
                    IntVector2 end = pixel;
                    if (holdingCtrl)
                    {
                ...
                else if (toolbar.shapeToolShape == ShapeTool.ShapeMode.IsometricHexagon)
                {
                    IntVector2 end = pixel;
                    if (holdingCtrl)
                    {
