...
namespace PAC.Geometry.Shapes
{
    ...
    public class IsometricHexagon : IIsometricShape<IsometricHexagon>, IFlippableShape<IsometricHexagon, CardinalAxis>, IDeepCopyableShape<IsometricHexagon>, IEquatable<IsometricHexagon>
    {
        ...
        public static IsometricHexagon operator +(IsometricHexagon isometricHexagon, IntVector2 translation) => isometricHexagon.Translate(translation);
        /// <summary>
        /// Returns a deep copy of the <see cref="IsometricHexagon"/> translated by the given vector.
        /// </summary>
        /// <seealso cref="Translate(IntVector2)"/>
        ...
        /// </summary>
        /// <seealso cref="Flip(CardinalAxis)"/>
        ...
        public IsometricHexagon Translate(IntVector2 translation) => new IsometricHexagon(boundingRect + translation, filled);

        public IsometricHexagon Flip(VerticalAxis axis) => Flip((CardinalAxis)axis);
        public IsometricHexagon Flip(CardinalAxis axis) => new IsometricHexagon(boundingRect.Flip(axis), filled);
